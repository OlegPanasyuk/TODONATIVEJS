document.addEventListener('DOMContentLoaded', (e) => {
  ...
  // view.render(test);
  // view2.render(test);
  let incomingData = getObjcts();
  let model = new itemsToDo__model(incomingData);
  let view = new itemsToDo__view(model);
  let controller = new itemsToDo__controller(view, model);

  view.render(document.getElementById('test'));
});